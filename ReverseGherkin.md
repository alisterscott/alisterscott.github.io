---
title:  Reverse Gherkin
---

[**Reverse Gherkin**](https://github.com/alisterscott/reverse-gherkin): write your Playwright specs as code and get plain language business readable specs on GitHub when you run them.
...
This is done by a [custom reporter](https://github.com/alisterscott/reverse-gherkin/blob/main/reverse-gherkin-reporter.ts) with an option to include the annotations or not:
...
![GitHub Actions Summary](media/ghactionssummary.png)