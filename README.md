...
1. Automated e2e Testing
   1. [All Things Testing Brisbane Meetup Presentation](/Automatede2eTesting/AllThingsTestingBrisbaneMeetup.md)
   2. [Approval Testing](/Automatede2eTesting//ApprovalTesting.md)
   3. [Automatically Checking for Browser Console Errors with Playwright](/Automatede2eTesting/AutomaticallyCheckingForPlaywrightConsoleErrors.md)
   4. [Automatically Capturing Browser Client Side Performance Logs with Playwright](/Automatede2eTesting/performanceLogs.md)
   5. [Example Repositories](/Automatede2eTesting/ExampleRepos.md)
   6. [Page Objects](/Automatede2eTesting//PageObjects.md)
   7. [Parallel Execution & Playwright Workers](/Automatede2eTesting//ParallelExecution.md)
...
15. [The importance of T‑shaped skills in the dust‑storm that is Ai](/Ai.md) 🆕
